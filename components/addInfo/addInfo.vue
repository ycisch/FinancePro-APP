    ...
    <view class="form-container">
        <u-form :model="form" ref="uForm">
            <u-form-item label="金额">
                <!-- <u--text text="金额" size="15" prefixIcon="rmb"></u--text> -->
            ...
            <u-form-item prop="type" borderBottom @click="clickType" label="分类">
                <!-- <u--text text="分类" size="15" prefixIcon="order"></u--text> -->
            ...
            <u-form-item  prop="date" borderBottom @click="clickCalendar" label="时间">
                <!-- <u--text text="时间" size="15" prefixIcon="calendar"></u--text> -->
                <u--input  v-model="form.date" placeholder="请选择时间"
                    border="none"></u--input>
                <u-icon slot="right" name="arrow-right"></u-icon>
            </u-form-item>
            <u-form-item label="状态">
                <!-- <u--text text="状态" size="15" prefixIcon="setting"></u--text> -->
